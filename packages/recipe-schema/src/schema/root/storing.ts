...
/**
 * How to store resulting food. If all components have "storing" value set then they should all be
 * available in some fashion or aother. It is not supported to set the storing procedure for all
